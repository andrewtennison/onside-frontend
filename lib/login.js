...
var resolveOnComplete = function(promise, data, response, fulfillErrors){
...
exports.all = function(conf){
  ...
  everyauth.everymodule.handleLogout( function (req, res) {
	...
	everyauth
      ...
      console.log("Posting to api: " + conf.apiPath + '/user/login');
			...
			.on('complete', function(data, response) {
				promise = resolveOnComplete(promise, data, response, true);
			});
			return promise;
		})
    ...
    .extractExtraRegistrationParams(function(req){
      ...
      .on('complete', function(data, response) {
        promise = resolveOnComplete(promise, data, response);
      });
      return promise;
		})
